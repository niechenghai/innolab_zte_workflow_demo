sap.ui.define([
	...
	"sap/ui/Device",
	"com/zte/HTML5Module/model/models"
], function (UIComponent, Device, models) {
	"use strict";

	return UIComponent.extend("com.zte.HTML5Module.Component", {
        ...
        _getWorkflowRuntimeBaseURL: function () {
            ...
            return "/" + componentName + "/bpmworkflowruntime/v1";
        },
        ...
        getInboxAPI: function () {
            ...
            console.log("getInboxAPI queryParameters=", queryParameters);
        ...
        _patchTaskInstance: function () { 
            ...
            jQuery.ajax({
                url: this._getTaskInstancesBaseURL(), method: "PATCH",
        ...
        _fetchToken: function () {
            var fetchedToken;
            jQuery.ajax({
                url: this._getWorkflowRuntimeBaseURL() + "/xsrf-token", method: "GET",
                async: false,
                headers: {
                    "X-CSRF-Token": "Fetch" 
                },
